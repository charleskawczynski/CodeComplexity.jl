...
# Hook into the generic pipeline so that `measure_report(ArgumentCountComplexity(),
# code; ignore=...)` drops named definitions before any `max_value` filtering.
